...
const ICONS = [Flame, Bike, Car, Flame, Gamepad2, Music2]
      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-10">
        <div className="flex items-end justify-between gap-8">
          <div>
            ...
            <h2 className="text-4xl font-black uppercase leading-[0.88] tracking-[-0.04em] sm:text-5xl md:text-7xl">
              More than
              <br />
              <span className="text-red-500">motorsport.</span>
            </h2>
            <p className="mt-6 max-w-xl text-base leading-7 text-white/45 md:text-lg">
              Six experiences. One destination. Move through the world of TOR&apos;Q.
            </p>
          </div>
          <div className="hidden text-right md:block">
            <p className="text-[10px] uppercase tracking-[0.3em] text-white/25">Explore</p>
            ...
            {EXPERIENCES.map((experience, index) => {
              ...
              return (
                <article
                  ...
                  className={`
                    group relative h-[390px] w-[82vw] shrink-0 snap-center
                    overflow-hidden rounded-2xl border border-white/10 bg-neutral-950
                    transition-all duration-500
                    sm:h-[420px] sm:w-[70vw]
                    md:h-[430px] md:w-[58vw] md:max-w-[860px]
                    ${isActive ? 'opacity-100 md:scale-100' : 'opacity-100 md:scale-[0.96] md:opacity-70'}
                  `}
                >
                  <div
                    className="absolute inset-0 bg-cover bg-center opacity-45 transition-all duration-700 group-hover:scale-105 group-hover:opacity-60"
                    style={{ backgroundImage: `url(${experience.image})` }}
                  />
                  <div className="absolute inset-0 bg-gradient-to-r from-black via-black/65 to-black/10" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent" />

                  <div className="relative flex h-full flex-col justify-between p-7 sm:p-8 lg:p-10">
                    <div className="flex items-start justify-between">
                      <div className="flex h-12 w-12 items-center justify-center rounded-full border border-white/20 bg-white/5">
                        <Icon size={21} strokeWidth={1.7} />
                      </div>
                      <span className="text-7xl font-black leading-none text-white/[0.06]">
                        {experience.number}
                      </span>
                    </div>
                    ...
                    <div className="max-w-xl">
                      ...
                      <h3 className="text-4xl font-black uppercase leading-none tracking-tight sm:text-5xl">
                        {experience.title}
                      </h3>
                    ...
                    <div className="absolute bottom-7 right-7 flex h-11 w-11 items-center justify-center rounded-full border border-white/20 transition-all duration-500 group-hover:border-red-500 group-hover:bg-red-500 sm:bottom-8 sm:right-8">
