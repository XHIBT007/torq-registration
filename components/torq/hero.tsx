...
export function Hero() {
   ...
   * ==========================================================
   *
   * Prevents a zero-sized first render before the viewport
  ...
  /*
   * ==========================================================
   * RESPONSIVE MECHANICAL LOGO
   * ==========================================================
   *
   * IMPORTANT:
   *
   * The actual logo canvas remains EXACTLY:
   *
   * 790 × 316
   *
   * We only scale that canvas.
   *
   * Landscape is now constrained by BOTH:
   *
   * - viewport width
   * - viewport height
   *
   * This prevents the desktop/landscape logo from becoming
   * oversized and being cropped vertically.
   */
  ...
  if (isVeryShortLandscape) {
     ...
     * Full desktop.
     *
     * Still constrained by height so a short desktop/laptop
     * screen can never create a cropped logo.
     */
    stageDisplayWidth =
      Math.min(
        viewportWidth * 0.68,
   ...
   * ==========================================================
   *
   * Landscape typography now responds to HEIGHT rather than
   * becoming huge simply because the screen is wide.
   */
  ...
  if (isVeryShortLandscape) {
    ...
    headlineSize =
      'clamp(50px, 6.4vw, 92px)'

    contentWidth =
      'min(820px, 60vw)'

    /*
     * Desktop content scales down slightly on short
     * screens instead of overflowing vertically.
     */
    contentScale =
      Math.min(
        1,
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <p className="mb-2 text-[8px] uppercase tracking-[.35em] text-white/50 sm:mb-3 sm:text-[9px]">
        ...
        >
          ...
          >
            ...
            >
              <span className="whitespace-nowrap text-[7px] font-semibold uppercase tracking-[.3em] text-white/45 sm:text-[10px]">
                Scroll down to experience TOR&apos;Q
              </span>

              <div className="flex flex-col items-center">
                <div className="h-5 w-px bg-gradient-to-b from-white/50 to-transparent sm:h-7" />
  ...
  return (
    <img
      ...
      style={{
         ...
         * ======================================================
         *
         * The component alignment depends on this exact
         * transform origin.
         */
